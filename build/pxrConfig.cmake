...
if(ON)
    if (NOT DEFINED Python3_EXECUTABLE)
        if (NOT [[/pixar/d2/sets/vfx2022.003/bin/python]] STREQUAL "")
            set(Python3_EXECUTABLE [[/pixar/d2/sets/vfx2022.003/bin/python]])
        endif()
    endif()

    if (NOT DEFINED Python3_LIBRARY)
        if (NOT [[/pixar/d2/sets/vfx2022.003/lib/libpython3.9.so]] STREQUAL "")
            set(Python3_LIBRARY [[/pixar/d2/sets/vfx2022.003/lib/libpython3.9.so]])
        endif()
    endif()

    if (NOT DEFINED Python3_INCLUDE_DIR)
        if (NOT [[/pixar/d2/sets/vfx2022.003/include/python3.9]] STREQUAL "")
            set(Python3_INCLUDE_DIR [[/pixar/d2/sets/vfx2022.003/include/python3.9]])
        endif()
    endif()

    if (NOT DEFINED Python3_VERSION)
        find_package(Python3 "3.9.16" EXACT COMPONENTS Development REQUIRED)
    else()
...
if(OFF)
    if (NOT DEFINED MaterialX_DIR)
        if (NOT [[/pixar/d2/sets/vfx2022.003/packages/MaterialX-1.38.7/lib/cmake/MaterialX]] STREQUAL "")
            set(MaterialX_DIR [[/pixar/d2/sets/vfx2022.003/packages/MaterialX-1.38.7/lib/cmake/MaterialX]])
        endif()
    endif()
...
if(1)
    if (NOT DEFINED Imath_DIR)
        if (NOT [[/pixar/d2/sets/vfx2022.003/lib/cmake/Imath]] STREQUAL "")
            set(Imath_DIR [[/pixar/d2/sets/vfx2022.003/lib/cmake/Imath]])
        endif()
    endif()
